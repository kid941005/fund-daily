...
class TestFundDatabaseFunctions:
    ...
    def test_save_fund_nav(self, test_fund_code):
        ...
        # 首先确保基金存在
        from db import get_fund_nav, save_fund_info, save_fund_nav
    ...
    def test_save_fund_score(self, test_fund_code):
        ...
        # 首先确保基金存在
        from db import get_fund_score, save_fund_info, save_fund_score
    ...
    def test_save_fund_data_comprehensive(self, test_fund_code):
        ...
        from db import get_fund_info, get_fund_nav, get_fund_score, save_fund_data
        ...
        fund_data = {
            ...
            "score_100": {
                "total_score": 78,
                "valuation": {"score": 8, "reason": "估值合理"},
                "sector": {"score": 7, "reason": "行业前景良好"},
                "risk_control": {"score": 6, "reason": "风险控制一般"},
            },
        }
...
class TestDatabasePerformance:
    ...
    def test_batch_operations(self):
        ...
        for i in range(10):
            ...
            save_fund_info(
                fund_code=fund_code, fund_name=f"批量测试基金{i}", fund_type="测试型", fund_company="批量测试公司"
            )
