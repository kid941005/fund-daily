...
class TestCacheManager:
    ...
    def test_get_with_penetration_protection_valid(self):
        ...
        value = manager.get_with_penetration_protection("test_key", loader, ttl=300, empty_ttl=60)
    ...
    def test_get_with_penetration_protection_empty(self):
        ...
        value = manager.get_with_penetration_protection("empty_key", loader, ttl=300, empty_ttl=60)
