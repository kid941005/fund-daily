...
class TestTaskContext:
    ...
    def test_task_context_update_progress(self):
        ...
        context = TaskContext(
            task_id="test-123", params={}, cancel_event=threading.Event(), update_progress_func=update_func
        )
...
class TestTaskRegistry:
    ...
    def test_register_task_decorator(self):
        ...
        @registry.register(task_type="test_task", name="Test Task", description="A test task")
...
class TestBackgroundTaskManager:
    ...
    def test_submit_task_validation(self):
        ...
        with patch.object(BackgroundTaskManager, "_init_redis"):
            ...
            task_id = mgr.submit(task_type="fund_fetch", params={"codes": ["000001"]}, user_id="user123")
    ...
    def test_get_task(self):
        ...
        with patch.object(BackgroundTaskManager, "_init_redis"):
            ...
            mgr._memory_tasks = {}
            task = TaskInfo(task_type="fund_fetch", params={"codes": ["000001"]})
...
class TestTaskAPI:
    ...
    def test_task_submit_request(self):
        ...
        request = TaskSubmitRequest(task_type="fund_fetch", params={"codes": ["000001"]}, user_id="user123")
