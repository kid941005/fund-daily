...
class TestFormatReportForShare:
    ...
    def test_format_report(self):
        ...
        report = {
            ...
            "summary": {"total": 1, "up": 1, "down": 0, "flat": 0, "market_sentiment": "乐观"},
        }
...
class TestGenerateAdvice:
    ...
    def test_advice_bullish_market(self, mock_detail, mock_sentiment):
        ...
        mock_sentiment.return_value = {"sentiment": "乐观", "score": 50}
        mock_detail.return_value = {}

        funds = [{"fund_code": "000001", "fund_name": "测试基金", "daily_change": 2.0, "trend": "up"}]
    ...
    def test_advice_bearish_market(self, mock_detail, mock_sentiment):
        ...
        mock_sentiment.return_value = {"sentiment": "恐慌", "score": -50}
        mock_detail.return_value = {}

        funds = [{"fund_code": "000001", "fund_name": "测试基金", "daily_change": -3.0, "trend": "down"}]
    ...
    def test_advice_high_position(self, mock_detail, mock_sentiment):
        ...
        mock_sentiment.return_value = {"sentiment": "乐观", "score": 30}
        mock_detail.return_value = {}
...
class TestGetFundDetailInfo:
    ...
    def test_get_detail_success(self, mock_fetch_detail, mock_fetch_data):
        ...
        mock_fetch_data.return_value = {"code": "000001", "name": "测试基金"}
