...
try:
    from db import (
        save_fund_info, save_fund_nav, save_fund_score, save_fund_data,
        get_fund_info, get_fund_nav, get_fund_score, get_fund_history
    )
    HAS_DB = True
...
class EnhancedFetcher:
    ...
    def fetch_fund_data(self, fund_code: str, use_cache: bool = True, 
...
# 兼容性函数
def fetch_fund_data_enhanced(fund_code: str, use_cache: bool = True, 
                           force_refresh: bool = False) -> Dict:
